      ...
      <div className="mx-auto max-w-10xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-12 items-center justify-between">
          ...
          <Link href="/owner" className="flex items-center gap-2 group">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-amber-600 text-white shadow-amber-200 shadow-lg transition-transform group-hover:scale-105">
              <Building2 className="h-6 w-6" />
            </div>
            <span className="text-xl font-bold tracking-tight text-slate-900">
              ShaaShaa AI <span className="text-amber-600"></span>
            </span>
          </Link>
          ...
          <div className="hidden lg:flex lg:items-center lg:gap-4">
              ...
              {showNotifications && (
                ...
                >
                  <div className="flex items-center justify-between border-b border-slate-200 px-4 py-3">
                    ...
                    <p className="text-xs text-slate-500">{notifications.filter(n => !n.isRead).length} new alerts</p>
                    </div>
                    <button
                      type="button"
            ...
            <Link
              href="/owner/login"
              className="hidden rounded-full bg-amber-600 px-4 py-2 text-sm font-semibold text-white transition hover:bg-amber-700 md:inline-flex items-center gap-2"
            >
            ...
            <div className="flex items-center gap-3">
              <div className="flex flex-col items-end">
                ...
                <span className="text-[10px] font-medium text-amber-600 uppercase tracking-wider mt-1">
                  Owner
                </span>
              </div>
        ...
        <div className="lg:hidden bg-white border-t border-slate-100 animate-in slide-in-from-top duration-300">
          <div className="space-y-1 px-4 pb-3 pt-2">
            ...
            <Link
              href="/owner/login"
              onClick={() => setIsOpen(false)}
              className="flex w-full items-center gap-3 rounded-lg px-3 py-3 text-base font-medium text-amber-600 hover:bg-amber-50 transition-colors"
            >
